---
title: Introducing {twohundredfiftythings}
author: Liz Roten
date: '2020-05-10'
slug: introducing-twohundredfiftythings
description: A package inspired by Michael Sorkin's "Two Hundred Fifty Things an Architect Should Know."
categories:
  - blog
  - package development
tags:
...
I decided to get a little wild with my Sunday, so I wrote a tiny R package! I also submitted it to CRAN. Its my first time submitting to CRAN, but I'm feeling hopeful! 

[`{twohundredfiftythings}`](https://github.com/eroten/twohundredfiftythings) is a tiny R package that allows the user to access Michael Sorkin's list of things an architect should know. The list was originally published in "What Goes Up: The Rights and Wrongs to a City". 
...
You can check this package out on [GitHub.](https://github.com/eroten/twohundredfiftythings) Feel free to contribute or submit any issues you find!