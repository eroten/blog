...
description: A few maps inspired by Harold Fisk's 1944 geological investigation
author: Liz Roten
date: '2019-10-27'
slug: 2019-10-27-fisk-s-mississippi-river-meander-in-r
categories:
  - R
  - Data Visualization
  - cartography
...
!["Alluvial Valley of the Lower Mississippi River by Harold Fisk, 1944" courtesy of Radical Cartography](http://www.radicalcartography.net/fisk/fisk07.jpg) 
...
```
```{r, echo = FALSE}
saucier <- readRDS("2019-10-27-assets/saucier_orig.RDS")
```
...
```
```{r, echo = FALSE}
meta_xml <- read_xml("2019-10-27-assets/Saucier_Geomorph_FGDC.xml")
```
...
```
```{r, echo = FALSE}
ms_r_1983 <- readRDS("2019-10-27-assets/ms_r_1983.RDS")
```
...
![Edited map of Mississippi River with Pleistocene features](/posts/2019-10-27-fisk-s-mississippi-river-meander-in-r_files/final_map.png)  
